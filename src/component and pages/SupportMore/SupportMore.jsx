        ...
        <>
            ...
            <div className="supportmore">
                <div className="supportmore__container">
                    <h3 className="supportmore__container--title"> {textDataBaseSTATE.title} </h3>

                    <div className="supportmore__container--group">
                        {
                            textDataBaseSTATE.questions.map(
                                (element, index) => {
                                    return (
                                        <p className="supportmore__container--group_questions" id={`q_${index}`} key={index} onClick={
                                            () => {
                                            ...
                                            {element}
                                            <div className="supportmore__container--group_questions-answers" id={index}>
